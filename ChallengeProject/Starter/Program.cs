  ...
  switch (menuSelection)
  {
    ...
    case "3":
      ...
      for (int i = 0; i < maxPets; i++)
      {
        ...
        {
          bool validAge = false;
          // Check and update age if needed
          ...
          // Check and update physical description if needed
          if (ourAnimals[i, 4] == "Physical description: " || ourAnimals[i, 4] == "Physical description: tbd")
          {
            do
            {
              ...
              if (!string.IsNullOrWhiteSpace(readResult))
                ourAnimals[i, 4] = $"Physical description: {readResult.ToLower().Trim()}";
      ...
      Console.WriteLine("Age and physical description fields are complete for all our animal friends.");
      Console.WriteLine("Press the Enter key to continue.");
      readResult = Console.ReadLine();
      break;
        ...
        if (ourAnimals[i, 0] != "ID #: ")
        {
          if (ourAnimals[i, 3] == "Nickname: tbd" || ourAnimals[i, 3] == "Nickname: ")
          {
            ...
            do
            {
              ...
              {
                ourAnimals[i, 3] = $"Nickname: {readResult.ToLower().Trim()}";
                validEntry = true;
              }
            } while (!validEntry);
          }
          ...
          if (ourAnimals[i, 5] == "Personality: tbd" || ourAnimals[i, 5] == "Personality: ")
          {
            ...
            do
            {
              ...
              if (!string.IsNullOrEmpty(readResult))
              {
                ourAnimals[i, 5] = $"Personality: {readResult.ToLower().Trim()}";
                validEntry = true;
              }
            } while (!validEntry);
          }
